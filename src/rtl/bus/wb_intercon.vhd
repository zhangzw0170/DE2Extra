...
entity wb_intercon is
    port (
        ...
        -- Slave 1: VGA text/pixel window @ 0xF0000000 (32KB)
        ...
        -- Slave 2: PS/2 controller @ 0xF0008000
        ...
        -- Slave 3: IR receiver @ 0xF000C000
        ...
        -- Slave 4: NTT accelerator @ 0xF000F000
        ...
        -- Slave 5: LCD controller @ 0xF000B000
        ...
        -- Slave 6: Build Info ROM @ 0xF0009000
...
begin
    ...
    m_err_o <= m_stb_i and m_cyc_i and not (cs_sdram or cs_vga or cs_ps2 or cs_ir or cs_ntt or cs_lcd or cs_tmr or cs_intc or cs_expdemo or cs_pong or cs_conway);
