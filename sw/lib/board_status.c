...
static const char *program_title(uint8_t prog_id) {
    switch (prog_id & 0x0fu) {
        ...
        case 2u:  return "DE2Extra Crypto";
        case 3u:  return "DE2Extra PS/2";
        case 4u:  return "DE2Extra Snake";
        case 5u:  return "DE2Extra Life";
        case 6u:  return "DE2Extra Info";
        case 7u:  return "DE2Extra Monitor";
