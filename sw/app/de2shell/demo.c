...
static const exp_entry_t exp_entries[] = {
    ...
    {3,  "Exp3",  "7-Segment Scan",
     "SW17:16 choose sub-mode; in clock mode SW15:14 choose page and SW7:4/SW3:0 set BCD tens/ones",
     "KEY1 = reset, KEY2 = write minute, KEY3 = write hour",
     "Clock pages: 00 time, 01 time-set, 10 alarm, 11 alarm-set; original KEY0 second-write is removed"},
